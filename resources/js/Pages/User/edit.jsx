...
const EditUser = ({ user, tiposUsuarios, pais, documento }) => {
    const { data, setData, put, processing, errors } = useForm({
        primer_nombre: user.primer_nombre || '',
        segundo_nombre: user.segundo_nombre || '',
        otros_nombres: user.otros_nombres || '',
        primer_apellido: user.primer_apellido || '',
        segundo_apellido: user.segundo_apellido || '',
        tipo_documento_identificacion: user.tipo_documento_identificacion || '',
        identificacion: user.identificacion || '',
        telefono_1: user.telefono_1 || '',
        telefono_2: user.telefono_2 || '',
        usuario: user.usuario || '',
        correo_electronico: user.correo_electronico || '',
        password: '', // Permitir cambio de contraseña opcional
        pais: user.pais || '',
        estado: user.estado || '',
        ciudad: user.ciudad || '',
    ...
    useEffect(() => {
        // Cargar los datos del usuario si es necesario
        setData(user);
    }, [user]);
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                id="pais"
                                value={data.pais} // Mantiene el valor seleccionado según data.pais
